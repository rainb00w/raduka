      ...
      <div className={styles.main_container}>
        ...
        <p>
          <em>
            ...
            <br></br>
            <br></br> Всё трудное для того послано, чтобы, видя собственное
            несовершенство, оставил рожденный всякое осуждение. Преисполнившись
            любви к себе и священное внутри увидев — в каждом его нашел. Чтобы
            испытав страдание собственное, сострадание к ближнему он обрел. {" "}
            <br></br>
